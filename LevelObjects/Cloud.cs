...
namespace TickTickBoom
{
    class Cloud : SpriteGameObject
    {
        ...
        public Cloud(Level level) : base(null, TickTickBoom.DEPTH_LAYER_BACKGROUND)
        {
            this.level = level;
            Reset();
        }
        ...
        void Randomize()
        {
            ...
            float depth = TickTickBoom.DEPTH_LAYER_BACKGROUND + (float)ExtendedGame.Random.NextDouble() * 0.2f;
